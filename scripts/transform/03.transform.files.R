...
cadastro_filtrados <-
  subset(cadastro,
         ...
         condicao_sit & 
         condicao_tp_merc & 
         condicao_sit_emissor)

############
# Análise exploratória

## quantidade de linhas
nrow(cadastro_filtrados)

## verificando ocorrencia de duplicidade de nome
n_distinct(cadastro_filtrados$DENOM_SOCIAL)

nrow(cadastro_filtrados) - n_distinct(cadastro_filtrados$DENOM_SOCIAL)
